define(['jquery', 'frameworks/spine', 'frameworks/handlebars', 'frameworks/underscore', 'plugins/timeago.jquery', 'core/photobox', "photo/photo", "photo/comment"], function()
{
    ...
    var StreamApp = Spine.Controller.sub(
    {
        ...
        events: {
            ...
            "click .dismiss_intro": "dismissIntro"
        },
        ...
        dismissIntro: function(e)
        {
            e.preventDefault();
            this.intro_header.hide();
            $.post(Global.settings.rurl+'feed/complete_intro');
        },
