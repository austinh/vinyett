...
class PhotoMappedConstructor extends Constructor
{
   ...
   */
    public function render() 
    {
      ...
      //$aw = $this->getActivityCacheManager();
      ...
      return $this->getTemplating()->render("StreamBundle:Feed:photo.mapped.html.twig", array("comments" => $comments, "activity" => $activity, "photo" => $data["Vinyett\PhotoBundle\Entity\Photo"]));
