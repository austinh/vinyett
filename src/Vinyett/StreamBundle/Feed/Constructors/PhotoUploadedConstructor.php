...
class PhotoUploadedConstructor extends Constructor
{
   ...
   */
    public function render() 
    {
      ...
      return $this->getTemplating()->render("StreamBundle:Feed:photo.uploaded.html.twig", array("activity" => $activity, "photo" => $data["Vinyett\PhotoBundle\Entity\Photo"]));
