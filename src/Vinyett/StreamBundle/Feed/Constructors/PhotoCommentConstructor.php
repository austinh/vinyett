...
class PhotoCommentConstructor extends Constructor
{
   ...
   */
    public function render() 
    {
      ...
      return $this->getTemplating()->render("StreamBundle:Feed:photo.comment.html.twig", array("comments" => $comments, "activity" => $activity, "photo" => $data["Vinyett\PhotoBundle\Entity\Photo"], "comment" => $data['resource']));
